...
The educational focus of the TaleBlazer project requires that the impact of TaleBlazer games on learning be measured. Game designers and educational researchers are supremely interested in seeing exactly how players play their game in order to draw conclusions as to the game's effectiveness. Existing solutions fail to provide useful analytics with a desirable level of privacy. To this end, it was necessary to build TaleBlazer Analytics to meet our requirements. 

\subsection{Purpose of Data Collection}

Game designers and researchers are supremely interested in seeing exactly how players play their game. Furthermore, it is important to also measure the impact of the game's content after the gameplay session has ended. To this end, it is necessary to capture data that allows interested parties to determine the relations between TaleBlazer games and learning. 
